/********************************************************************************
** Form generated from reading UI file 'c_loadingToastWidget.ui'
**
...
#ifndef UI_C_LOADINGTOASTWIDGET_H
#define UI_C_LOADINGTOASTWIDGET_H
...
public:
    ...
    void setupUi(QWidget *LoadingToastWidget)
    {
        if (LoadingToastWidget->objectName().isEmpty())
            LoadingToastWidget->setObjectName(QString::fromUtf8("LoadingToastWidget"));
        LoadingToastWidget->resize(200, 200);
        gridLayout = new QGridLayout(LoadingToastWidget);
        gridLayout->setSpacing(0);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        mask = new QFrame(LoadingToastWidget);
...
"background: none;"));
        ...
        retranslateUi(LoadingToastWidget);

        QMetaObject::connectSlotsByName(LoadingToastWidget);
    } // setupUi

    void retranslateUi(QWidget *LoadingToastWidget)
    {
        LoadingToastWidget->setWindowTitle(QCoreApplication::translate("LoadingToastWidget", "Form", nullptr));
        tips_text->setText(QCoreApplication::translate("LoadingToastWidget", "Loading...", nullptr));
    } // retranslateUi

};

namespace Ui {
    class LoadingToastWidget: public Ui_LoadingToastWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_C_LOADINGTOASTWIDGET_H
