/********************************************************************************
** Form generated from reading UI file 't_onlineClassroomWidget.ui'
**
...
#ifndef UI_T_ONLINECLASSROOMWIDGET_H
#define UI_T_ONLINECLASSROOMWIDGET_H
...
class Ui_TOnlineClassroomWidget
{
public:
    ...
    {
        if (TOnlineClassroomWidget->objectName().isEmpty())
...
"}"));
        ...
        function_tabWidget = new QTabWidget(TOnlineClassroomWidget);
...
"}"));
        ...
        buttonGroup = new QButtonGroup(TOnlineClassroomWidget);
...
"}"));
        ...
        gridLayout_13 = new QGridLayout(flexible_frame);
...
"}"));
        ...
        gridLayout_13->addWidget(flexible_frame_btn, 0, 0, 1, 1);
...
"}"));
        ...
        gridLayout_14 = new QGridLayout(flexible_main_area);
        gridLayout_14->setObjectName(QString::fromUtf8("gridLayout_14"));
        gridLayout_14->setContentsMargins(5, 5, 5, 5);
        label_34 = new QLabel(flexible_main_area);
...
"}"));
        ...
        gridLayout_14->addWidget(label_34, 0, 1, 1, 1);

        remove_btn = new QPushButton(flexible_main_area);
...
"}"));
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/button/Resources/material/button/remove.png"), QSize(), QIcon::Normal, QIcon::Off);
        remove_btn->setIcon(icon13);
        remove_btn->setIconSize(QSize(13, 13));

        gridLayout_14->addWidget(remove_btn, 0, 2, 1, 1);

        horizontalSpacer_2 = new QSpacerItem(20, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

        gridLayout_14->addItem(horizontalSpacer_2, 0, 0, 1, 1);
        ...
        gridLayout_16 = new QGridLayout(in_speech_member_frame);
...
"}"));
        ...
        gridLayout_16->addWidget(in_speech_member_view, 0, 0, 1, 1);


        gridLayout_14->addWidget(in_speech_member_frame, 2, 0, 1, 3);
        ...
        gridLayout_15 = new QGridLayout(chat_frame);
...
"}"));
        ...
        gridLayout_15->addWidget(chat_text_edit, 2, 0, 1, 1);
...
""));
        ...
        gridLayout_15->addWidget(chat_view, 0, 0, 1, 2);
...
"}"));
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/button/Resources/material/button/send.png"), QSize(), QIcon::Normal, QIcon::Off);
        send_btn->setIcon(icon14);

        gridLayout_15->addWidget(send_btn, 2, 1, 1, 1);
...
"}"));
        ...
        gridLayout_17 = new QGridLayout(tool_btn_frame);
        gridLayout_17->setSpacing(0);
        gridLayout_17->setObjectName(QString::fromUtf8("gridLayout_17"));
        gridLayout_17->setContentsMargins(5, 2, 5, 2);
...
"}"));
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/button/Resources/material/button/chat_clear.png"), QSize(), QIcon::Normal, QIcon::Off);
        chat_clear_btn->setIcon(icon15);
        chat_clear_btn->setIconSize(QSize(17, 17));
        chat_clear_btn->setCheckable(false);

        gridLayout_17->addWidget(chat_clear_btn, 0, 2, 1, 1);

        chat_ban_btn = new QPushButton(tool_btn_frame);
...
"}"));
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/button/Resources/material/button/chat_ban.png"), QSize(), QIcon::Normal, QIcon::Off);
        chat_ban_btn->setIcon(icon16);
        chat_ban_btn->setIconSize(QSize(15, 15));
        chat_ban_btn->setCheckable(true);

        gridLayout_17->addWidget(chat_ban_btn, 0, 0, 1, 1);
        ...
        gridLayout_17->addWidget(tips_text, 0, 1, 1, 1);


        gridLayout_15->addWidget(tool_btn_frame, 1, 0, 1, 2);


        gridLayout_14->addWidget(chat_frame, 5, 0, 1, 3);

        label_33 = new QLabel(flexible_main_area);
...
"}"));
        ...
        gridLayout_14->addWidget(label_33, 4, 0, 1, 3);


        gridLayout_13->addWidget(flexible_main_area, 0, 1, 1, 1);
...
"}"));
        ...
        buttonGroup_2 = new QButtonGroup(TOnlineClassroomWidget);
...
"}"));
        ...
        function_btn_frame = new QFrame(TOnlineClassroomWidget);
...
"}"));
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/button/Resources/material/button/raise_hand.png"), QSize(), QIcon::Normal, QIcon::Off);
        raise_hand_btn->setIcon(icon17);
...
"}"));
        ...
        frame_2 = new QFrame(TOnlineClassroomWidget);
...
"}"));
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/button/Resources/material/button/voice.png"), QSize(), QIcon::Active, QIcon::Off);
        icon19.addFile(QString::fromUtf8(":/button/Resources/material/button/voice_close.png"), QSize(), QIcon::Active, QIcon::On);
        pushButton_6->setIcon(icon19);
        ...
        begin_lesson_btn = new QPushButton(TOnlineClassroomWidget);
        begin_lesson_btn->setObjectName(QString::fromUtf8("begin_lesson_btn"));
        begin_lesson_btn->setMinimumSize(QSize(0, 30));
        begin_lesson_btn->setMaximumSize(QSize(16777215, 30));
...
"}"));
        ...
        gridLayout_2->addWidget(begin_lesson_btn, 0, 1, 1, 1);

        frame = new QFrame(TOnlineClassroomWidget);
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 198, 487));
...
"}"));
        ...
        gridLayout_8->addWidget(label_21, 15, 0, 1, 2);
...
"}"));
        ...
        gridLayout_8->addItem(verticalSpacer_5, 19, 0, 1, 8);
...
"}"));
        ...
        gridLayout_8->addWidget(label_20, 14, 0, 1, 8);
...
"}"));
        ...
        gridLayout_8->addWidget(checkBox_3, 16, 2, 1, 6);
...
"}"));
        ...
        gridLayout_8->addWidget(checkBox_2, 17, 2, 1, 6);
...
"}"));
        ...
        gridLayout_8->addWidget(label_22, 17, 0, 1, 2);

        verticalSpacer_7 = new QSpacerItem(20, 20, QSizePolicy::Minimum, QSizePolicy::Fixed);

        gridLayout_8->addItem(verticalSpacer_7, 13, 0, 1, 8);
...
"}"));
        ...
        gridLayout_8->addWidget(checkBox, 15, 2, 1, 6);
...
"}"));
        ...
        retranslateUi(TOnlineClassroomWidget);
        ...
        QMetaObject::connectSlotsByName(TOnlineClassroomWidget);
    } // setupUi

    void retranslateUi(QWidget *TOnlineClassroomWidget)
    {
        TOnlineClassroomWidget->setWindowTitle(QCoreApplication::translate("TOnlineClassroomWidget", "Form", nullptr));
#if QT_CONFIG(tooltip)
        add_board_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\346\226\260\345\273\272\347\224\273\346\235\277", nullptr));
#endif // QT_CONFIG(tooltip)
        add_board_btn->setText(QString());
#if QT_CONFIG(tooltip)
        black_pen_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\351\273\221\347\254\224", nullptr));
#endif // QT_CONFIG(tooltip)
        black_pen_btn->setText(QString());
#if QT_CONFIG(tooltip)
        red_pen_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\347\272\242\347\254\224", nullptr));
#endif // QT_CONFIG(tooltip)
        red_pen_btn->setText(QString());
#if QT_CONFIG(tooltip)
        blue_pen_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\350\223\235\347\254\224", nullptr));
#endif // QT_CONFIG(tooltip)
        blue_pen_btn->setText(QString());
#if QT_CONFIG(tooltip)
        color_pen_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\350\207\252\345\256\232\344\271\211\351\242\234\350\211\262", nullptr));
#endif // QT_CONFIG(tooltip)
        color_pen_btn->setText(QString());
#if QT_CONFIG(tooltip)
        text_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\346\217\222\345\205\245\346\226\207\346\234\254", nullptr));
#endif // QT_CONFIG(tooltip)
        text_btn->setText(QString());
#if QT_CONFIG(tooltip)
        line_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\347\233\264\347\272\277", nullptr));
#endif // QT_CONFIG(tooltip)
        line_btn->setText(QString());
#if QT_CONFIG(tooltip)
        rect_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\347\237\251\345\275\242", nullptr));
#endif // QT_CONFIG(tooltip)
        rect_btn->setText(QString());
#if QT_CONFIG(tooltip)
        ellipse_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\346\244\255\345\234\206", nullptr));
#endif // QT_CONFIG(tooltip)
        ellipse_btn->setText(QString());
#if QT_CONFIG(tooltip)
        clear_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\346\270\205\347\251\272\347\224\273\346\235\277", nullptr));
#endif // QT_CONFIG(tooltip)
        clear_btn->setText(QString());
#if QT_CONFIG(tooltip)
        undo_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\346\222\244\351\224\200", nullptr));
#endif // QT_CONFIG(tooltip)
        undo_btn->setText(QString());
#if QT_CONFIG(tooltip)
        rubber_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\346\251\241\347\232\256\346\252\253", nullptr));
#endif // QT_CONFIG(tooltip)
        rubber_btn->setText(QString());
        label_6->setText(QCoreApplication::translate("TOnlineClassroomWidget", "\347\224\273\347\254\224\347\262\227\347\273\206", nullptr));
        pen_width_edit->setText(QString());
        label_7->setText(QCoreApplication::translate("TOnlineClassroomWidget", "\346\251\241\347\232\256\346\252\253\347\262\227\347\273\206", nullptr));
        rubber_width_edit->setText(QString());
        flexible_frame_btn->setText(QString());
        label_34->setText(QCoreApplication::translate("TOnlineClassroomWidget", "\345\217\221\350\250\200\344\270\255", nullptr));
#if QT_CONFIG(tooltip)
        remove_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\347\247\273\351\231\244", nullptr));
#endif // QT_CONFIG(tooltip)
        remove_btn->setText(QString());
        chat_text_edit->setPlaceholderText(QCoreApplication::translate("TOnlineClassroomWidget", "\350\257\267\350\276\223\345\205\245\346\226\207\345\255\227", nullptr));
#if QT_CONFIG(tooltip)
        send_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\345\217\221\351\200\201", nullptr));
#endif // QT_CONFIG(tooltip)
        send_btn->setText(QString());
#if QT_CONFIG(shortcut)
        send_btn->setShortcut(QCoreApplication::translate("TOnlineClassroomWidget", "Enter", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        chat_clear_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\346\270\205\345\261\217", nullptr));
#endif // QT_CONFIG(tooltip)
        chat_clear_btn->setText(QString());
#if QT_CONFIG(tooltip)
        chat_ban_btn->setToolTip(QCoreApplication::translate("TOnlineClassroomWidget", "\347\246\201\350\250\200", nullptr));
#endif // QT_CONFIG(tooltip)
        chat_ban_btn->setText(QString());
        tips_text->setText(QString());
        label_33->setText(QCoreApplication::translate("TOnlineClassroomWidget", "\344\274\232\350\257\235\345\210\227\350\241\250", nullptr));
        function_tabWidget->setTabText(function_tabWidget->indexOf(board_tab), QCoreApplication::translate("TOnlineClassroomWidget", "\347\224\273\346\235\277", nullptr));
        label_10->setText(QCoreApplication::translate("TOnlineClassroomWidget", "\347\261\273\345\236\213  ", nullptr));
        pushButton_3->setText(QCoreApplication::translate("TOnlineClassroomWidget", "\345\217\221\350\265\267\346\217\220\351\227\256", nullptr));
        pushButton_2->setText(QCoreApplication::translate("TOnlineClassroomWidget", "\345\244\232\351\200\211", nullptr));
        label_9->setText(QCoreApplication::translate("TOnlineClassroomWidget", "        \351\200\211\351\241\271\344\270\252\346\225\260  ", nullptr));
        label_8->setText(QCoreApplication::translate("TOnlineClassroomWidget", "\342\227\217 \346\217\220\351\227\256\350\256\276\347\275\256", nullptr));
        comboBox->setItemText(0, QCoreApplication::translate("TOnlineClassroomWidget", "1", nullptr));
        comboBox->setItemText(1, QCoreApplication::translate("TOnlineClassroomWidget", "2", nullptr));
        comboBox->setItemText(2, QCoreApplication::translate("TOnlineClassroomWidget", "3", nullptr));
        comboBox->setItemText(3, QCoreApplication::translate("TOnlineClassroomWidget", "4", nullptr));
        comboBox->setItemText(4, QCoreApplication::translate("TOnlineClassroomWidget", "5", nullptr));
        comboBox->setItemText(5, QCoreApplication::translate("TOnlineClassroomWidget", "6", nullptr));
        comboBox->setItemText(6, QCoreApplication::translate("TOnlineClassroomWidget", "7", nullptr));
        comboBox->setItemText(7, QCoreApplication::translate("TOnlineClassroomWidget", "8", nullptr));
        comboBox->setItemText(8, QCoreApplication::translate("TOnlineClassroomWidget", "9", nullptr));
        comboBox->setItemText(9, QString());

        pushButton->setText(QCoreApplication::translate("TOnlineClassroomWidget", "\345