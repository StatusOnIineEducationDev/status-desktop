/********************************************************************************
** Form generated from reading UI file 's_mainWindow.ui'
**
...
#ifndef UI_S_MAINWINDOW_H
#define UI_S_MAINWINDOW_H
...
public:
    ...
    void setupUi(QMainWindow *SMainWindow)
    {
        if (SMainWindow->objectName().isEmpty())
            SMainWindow->setObjectName(QString::fromUtf8("SMainWindow"));
        SMainWindow->resize(990, 698);
        SMainWindow->setMinimumSize(QSize(990, 698));
        SMainWindow->setMaximumSize(QSize(16777215, 16777215));
        SMainWindow->setBaseSize(QSize(990, 698));
        centralwidget = new QWidget(SMainWindow);
...
"}"));
        ...
        buttonGroup = new QButtonGroup(SMainWindow);
...
"}"));
        ...
        SMainWindow->setCentralWidget(centralwidget);

        retranslateUi(SMainWindow);
        QObject::connect(close_btn, SIGNAL(clicked()), SMainWindow, SLOT(close()));
        QObject::connect(minus_btn, SIGNAL(clicked()), SMainWindow, SLOT(showMinimized()));

        QMetaObject::connectSlotsByName(SMainWindow);
    } // setupUi

    void retranslateUi(QMainWindow *SMainWindow)
    {
        SMainWindow->setWindowTitle(QCoreApplication::translate("SMainWindow", "MainWindow", nullptr));
        logo->setText(QString());
        client_type_text->setText(QCoreApplication::translate("SMainWindow", "\345\255\246\347\224\237\347\253\257", nullptr));
        user_pic->setText(QString());
        username_text->setText(QCoreApplication::translate("SMainWindow", "\345\255\246\347\224\237", nullptr));
        logout_btn->setText(QString());
        function_navigation_text->setText(QCoreApplication::translate("SMainWindow", "   \345\212\237\350\203\275\350\217\234\345\215\225", nullptr));
        course_btn->setText(QCoreApplication::translate("SMainWindow", " \350\257\276\347\250\213\347\256\241\347\220\206", nullptr));
        interaction_btn->setText(QCoreApplication::translate("SMainWindow", " \345\234\250\347\272\277\346\225\231\345\256\244", nullptr));
        history_btn->setText(QCoreApplication::translate("SMainWindow", " \345\216\206\345\217\262\350\256\260\345\275\225", nullptr));
        other_navigation_text->setText(QCoreApplication::translate("SMainWindow", "   \345\205\266\344\273\226", nullptr));
        setting_btn->setText(QCoreApplication::translate("SMainWindow", " \350\256\276\347\275\256", nullptr));
        document_btn->setText(QCoreApplication::translate("SMainWindow", " \344\275\277\347\224\250\345\270\256\345\212\251", nullptr));
        version_text->setText(QCoreApplication::translate("SMainWindow", "Version 1.0.0", nullptr));
        resize_icon->setText(QString());
#if QT_CONFIG(tooltip)
        undo_btn->setToolTip(QCoreApplication::translate("SMainWindow", "\345\220\216\351\200\200", nullptr));
#endif // QT_CONFIG(tooltip)
        undo_btn->setText(QString());
#if QT_CONFIG(tooltip)
        redo_btn->setToolTip(QCoreApplication::translate("SMainWindow", "\345\211\215\350\277\233", nullptr));
#endif // QT_CONFIG(tooltip)
        redo_btn->setText(QString());
#if QT_CONFIG(tooltip)
        minus_btn->setToolTip(QCoreApplication::translate("SMainWindow", "\346\234\200\345\260\217\345\214\226", nullptr));
#endif // QT_CONFIG(tooltip)
        minus_btn->setText(QString());
#if QT_CONFIG(tooltip)
        full_or_normal_btn->setToolTip(QCoreApplication::translate("SMainWindow", "\346\234\200\345\244\247\345\214\226", nullptr));
#endif // QT_CONFIG(tooltip)
        full_or_normal_btn->setText(QString());
#if QT_CONFIG(tooltip)
        close_btn->setToolTip(QCoreApplication::translate("SMainWindow", "\345\205\263\351\227\255", nullptr));
#endif // QT_CONFIG(tooltip)
