/********************************************************************************
** Form generated from reading UI file 'student_main_window.ui'
**
...
#ifndef UI_STUDENT_MAIN_WINDOW_H
#define UI_STUDENT_MAIN_WINDOW_H
...
public:
    ...
    void setupUi(QMainWindow *StudentMainWindow)
    {
        if (StudentMainWindow->objectName().isEmpty())
            StudentMainWindow->setObjectName(QString::fromUtf8("StudentMainWindow"));
        StudentMainWindow->resize(990, 698);
        StudentMainWindow->setMinimumSize(QSize(990, 698));
        StudentMainWindow->setMaximumSize(QSize(16777215, 16777215));
        StudentMainWindow->setBaseSize(QSize(990, 698));
...
"}"));
        ...
        buttonGroup = new QButtonGroup(StudentMainWindow);
...
"}"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/button/Resources/material/button/minus.png"), QSize(), QIcon::Normal, QIcon::Off);
        minus_btn->setIcon(icon6);
...
"}"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/button/Resources/material/button/full.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon7.addFile(QString::fromUtf8(":/button/Resources/material/button/full.png"), QSize(), QIcon::Active, QIcon::Off);
        icon7.addFile(QString::fromUtf8(":/button/Resources/material/button/normal.png"), QSize(), QIcon::Active, QIcon::On);
        full_or_normal_btn->setIcon(icon7);
...
"}"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/button/Resources/material/button/close.png"), QSize(), QIcon::Normal, QIcon::Off);
        close_btn->setIcon(icon8);
        ...
        QObject::connect(close_btn, SIGNAL(clicked()), StudentMainWindow, SLOT(close()));
        QObject::connect(minus_btn, SIGNAL(clicked()), StudentMainWindow, SLOT(showMinimized()));
    ...
    {
        StudentMainWindow->setWindowTitle(QCoreApplication::translate("StudentMainWindow", "MainWindow", nullptr));
        logo->setText(QString());
        client_type_text->setText(QCoreApplication::translate("StudentMainWindow", "\345\255\246\347\224\237\347\253\257", nullptr));
        user_pic->setText(QString());
        username_text->setText(QCoreApplication::translate("StudentMainWindow", "\345\255\246\347\224\237", nullptr));
        logout_btn->setText(QString());
        function_navigation_text->setText(QCoreApplication::translate("StudentMainWindow", "   \345\212\237\350\203\275\350\217\234\345\215\225", nullptr));
        course_btn->setText(QCoreApplication::translate("StudentMainWindow", " \350\257\276\347\250\213\347\256\241\347\220\206", nullptr));
        interaction_btn->setText(QCoreApplication::translate("StudentMainWindow", " \345\256\236\346\227\266\344\272\222\345\212\250", nullptr));
        history_btn->setText(QCoreApplication::translate("StudentMainWindow", " \345\216\206\345\217\262\350\256\260\345\275\225", nullptr));
        other_navigation_text->setText(QCoreApplication::translate("StudentMainWindow", "   \345\205\266\344\273\226", nullptr));
        setting_btn->setText(QCoreApplication::translate("StudentMainWindow", " \350\256\276\347\275\256", nullptr));
        document_btn->setText(QCoreApplication::translate("StudentMainWindow", " \344\275\277\347\224\250\345\270\256\345\212\251", nullptr));
        version_text->setText(QCoreApplication::translate("StudentMainWindow", "Version 1.0.0", nullptr));
        resize_icon->setText(QString());
#if QT_CONFIG(tooltip)
        minus_btn->setToolTip(QCoreApplication::translate("StudentMainWindow", "\346\234\200\345\260\217\345\214\226", nullptr));
#endif // QT_CONFIG(tooltip)
        minus_btn->setText(QString());
#if QT_CONFIG(tooltip)
        full_or_normal_btn->setToolTip(QCoreApplication::translate("StudentMainWindow", "\346\234\200\345\244\247\345\214\226", nullptr));
#endif // QT_CONFIG(tooltip)
        full_or_normal_btn->setText(QString());
#if QT_CONFIG(tooltip)
        close_btn->setToolTip(QCoreApplication::translate("StudentMainWindow", "\345\205\263\351\227\255", nullptr));
#endif // QT_CONFIG(tooltip)
...
#endif // UI_STUDENT_MAIN_WINDOW_H
