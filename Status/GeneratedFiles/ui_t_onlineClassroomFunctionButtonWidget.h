/********************************************************************************
** Form generated from reading UI file 't_onlineClassroomFunctionButtonWidget.ui'
**
...
#ifndef UI_T_ONLINECLASSROOMFUNCTIONBUTTONWIDGET_H
#define UI_T_ONLINECLASSROOMFUNCTIONBUTTONWIDGET_H
...
class Ui_TeacherOnlineClassroomFunctionButtonWidget
{
public:
    ...
    void setupUi(QWidget *TeacherOnlineClassroomFunctionButtonWidget)
    {
        if (TeacherOnlineClassroomFunctionButtonWidget->objectName().isEmpty())
            TeacherOnlineClassroomFunctionButtonWidget->setObjectName(QString::fromUtf8("TeacherOnlineClassroomFunctionButtonWidget"));
        TeacherOnlineClassroomFunctionButtonWidget->resize(825, 30);
        gridLayout = new QGridLayout(TeacherOnlineClassroomFunctionButtonWidget);
        gridLayout->setSpacing(0);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        function_btn_frame = new QFrame(TeacherOnlineClassroomFunctionButtonWidget);
...
"}"));
        ...
        retranslateUi(TeacherOnlineClassroomFunctionButtonWidget);

        QMetaObject::connectSlotsByName(TeacherOnlineClassroomFunctionButtonWidget);
    } // setupUi

    void retranslateUi(QWidget *TeacherOnlineClassroomFunctionButtonWidget)
    {
        TeacherOnlineClassroomFunctionButtonWidget->setWindowTitle(QCoreApplication::translate("TeacherOnlineClassroomFunctionButtonWidget", "Form", nullptr));
        label_35->setText(QCoreApplication::translate("TeacherOnlineClassroomFunctionButtonWidget", "\345\234\250\347\272\277\346\225\231\345\256\244", nullptr));
        raise_hand_btn->setText(QCoreApplication::translate("TeacherOnlineClassroomFunctionButtonWidget", "\344\270\276\346\211\213", nullptr));
        quit_lesson_btn->setText(QCoreApplication::translate("TeacherOnlineClassroomFunctionButtonWidget", "\351\200\200\345\207\272", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TeacherOnlineClassroomFunctionButtonWidget: public Ui_TeacherOnlineClassroomFunctionButtonWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_T_ONLINECLASSROOMFUNCTIONBUTTONWIDGET_H
