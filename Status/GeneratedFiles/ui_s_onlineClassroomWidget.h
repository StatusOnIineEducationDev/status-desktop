/********************************************************************************
** Form generated from reading UI file 's_onlineClassroomWidget.ui'
**
...
#ifndef UI_S_ONLINECLASSROOMWIDGET_H
#define UI_S_ONLINECLASSROOMWIDGET_H
...
"}"));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 607, 770));
...
"}"));
        QIcon icon22;
        icon22.addFile(QString::fromUtf8(":/button/Resources/material/button/voice.png"), QSize(), QIcon::Active, QIcon::Off);
        icon22.addFile(QString::fromUtf8(":/button/Resources/material/button/voice_close.png"), QSize(), QIcon::Active, QIcon::On);
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 198, 437));
...
"}"));
        ...
        gridLayout_8->addWidget(label_20, 14, 0, 1, 7);
...
"}"));
        ...
        gridLayout_8->addItem(verticalSpacer_5, 18, 0, 1, 7);
...
"}"));
        ...
        gridLayout_8->addWidget(checkBox, 15, 3, 1, 4);
...
"}"));
        ...
        gridLayout_8->addWidget(checkBox_3, 16, 3, 1, 4);
...
"}"));
        ...
        gridLayout_8->addWidget(label_23, 16, 0, 1, 3);

        verticalSpacer_7 = new QSpacerItem(20, 20, QSizePolicy::Minimum, QSizePolicy::Fixed);

        gridLayout_8->addItem(verticalSpacer_7, 13, 0, 1, 7);
...
"}"));
        ...
        gridLayout_8->addWidget(label_21, 15, 0, 1, 3);
...
"}"));
        QIcon icon23;
        icon23.addFile(QString::fromUtf8(":/button/Resources/material/button/raise_hand.png"), QSize(), QIcon::Normal, QIcon::Off);
        raise_hand_btn->setIcon(icon23);
...
"}"));
    ...
    void retranslateUi(QWidget *SOnlineClassroomWidget)
    {
        ...
        label_13->setText(QCoreApplication::translate("SOnlineClassroomWidget", "0", nullptr));
        label_14->setText(QCoreApplication::translate("SOnlineClassroomWidget", "600\347\247\222", nullptr));
...
#endif // UI_S_ONLINECLASSROOMWIDGET_H
