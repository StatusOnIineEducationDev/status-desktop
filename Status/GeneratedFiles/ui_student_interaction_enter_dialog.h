/********************************************************************************
** Form generated from reading UI file 'student_interaction_enter_dialog.ui'
**
...
#ifndef UI_STUDENT_INTERACTION_ENTER_DIALOG_H
#define UI_STUDENT_INTERACTION_ENTER_DIALOG_H
...
class Ui_StudentInteractionEnterDialog
{
public:
    QFrame *layout;
    ...
    void setupUi(QDialog *StudentInteractionEnterDialog)
    {
        if (StudentInteractionEnterDialog->objectName().isEmpty())
            StudentInteractionEnterDialog->setObjectName(QString::fromUtf8("StudentInteractionEnterDialog"));
        StudentInteractionEnterDialog->resize(410, 260);
        StudentInteractionEnterDialog->setStyleSheet(QString::fromUtf8(""));
        layout = new QFrame(StudentInteractionEnterDialog);
...
"}"));
        ...
        retranslateUi(StudentInteractionEnterDialog);
        QObject::connect(close_btn, SIGNAL(clicked()), StudentInteractionEnterDialog, SLOT(close()));

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(StudentInteractionEnterDialog);
    } // setupUi

    void retranslateUi(QDialog *StudentInteractionEnterDialog)
    {
        StudentInteractionEnterDialog->setWindowTitle(QCoreApplication::translate("StudentInteractionEnterDialog", "Dialog", nullptr));
#if QT_CONFIG(tooltip)
        close_btn->setToolTip(QCoreApplication::translate("StudentInteractionEnterDialog", "\345\205\263\351\227\255", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        close_btn->setWhatsThis(QString());
#endif // QT_CONFIG(whatsthis)
        close_btn->setText(QString());
        title_text->setText(QCoreApplication::translate("StudentInteractionEnterDialog", "\350\277\233\345\205\245\350\257\276\345\256\244", nullptr));
        confirm_btn->setText(QCoreApplication::translate("StudentInteractionEnterDialog", "\350\277\233\345\205\245\350\257\276\345\256\244", nullptr));
        QTableWidgetItem *___qtablewidgetitem = courses_table->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("StudentInteractionEnterDialog", "\350\257\276\347\250\213id", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = courses_table->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("StudentInteractionEnterDialog", "\350\257\276\347\250\213\345\220\215", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = courses_table->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("StudentInteractionEnterDialog", "\347\212\266\346\200\201", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(mine_courses_tab), QCoreApplication::translate("StudentInteractionEnterDialog", "\346\210\221\347\232\204\350\257\276\347\250\213", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("StudentInteractionEnterDialog", "\344\270\264\346\227\266\346\210\277\351\227\264", nullptr));
        refresh_btn->setText(QCoreApplication::translate("StudentInteractionEnterDialog", "\345\210\267\346\226\260\345\210\227\350\241\250", nullptr));
    } // retranslateUi

};

namespace Ui {
    class StudentInteractionEnterDialog: public Ui_StudentInteractionEnterDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_STUDENT_INTERACTION_ENTER_DIALOG_H
