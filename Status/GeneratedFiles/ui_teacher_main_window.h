/********************************************************************************
** Form generated from reading UI file 'teacher_main_window.ui'
**
...
#ifndef UI_TEACHER_MAIN_WINDOW_H
#define UI_TEACHER_MAIN_WINDOW_H
...
public:
    ...
    void setupUi(QMainWindow *TeacherMainWindow)
    {
        if (TeacherMainWindow->objectName().isEmpty())
            TeacherMainWindow->setObjectName(QString::fromUtf8("TeacherMainWindow"));
        TeacherMainWindow->resize(990, 698);
        TeacherMainWindow->setMinimumSize(QSize(990, 698));
        TeacherMainWindow->setMaximumSize(QSize(16777215, 16777215));
        TeacherMainWindow->setBaseSize(QSize(990, 698));
...
"}"));
        ...
        buttonGroup = new QButtonGroup(TeacherMainWindow);
...
"}"));
        ...
        QObject::connect(close_btn, SIGNAL(clicked()), TeacherMainWindow, SLOT(close()));
        QObject::connect(minus_btn, SIGNAL(clicked()), TeacherMainWindow, SLOT(showMinimized()));
    ...
    void retranslateUi(QMainWindow *TeacherMainWindow)
    {
        ...
        client_type_text->setText(QCoreApplication::translate("TeacherMainWindow", "\346\225\231\345\270\210\347\253\257", nullptr));
        user_pic->setText(QString());
        username_text->setText(QCoreApplication::translate("TeacherMainWindow", "\346\210\221\346\230\257\344\275\240\347\210\270\347\210\270", nullptr));
        logout_btn->setText(QString());
        function_navigation_text->setText(QCoreApplication::translate("TeacherMainWindow", "   \345\212\237\350\203\275\350\217\234\345\215\225", nullptr));
        course_btn->setText(QCoreApplication::translate("TeacherMainWindow", " \350\257\276\347\250\213\347\256\241\347\220\206", nullptr));
        interaction_btn->setText(QCoreApplication::translate("TeacherMainWindow", " \345\256\236\346\227\266\344\272\222\345\212\250", nullptr));
        history_btn->setText(QCoreApplication::translate("TeacherMainWindow", " \345\216\206\345\217\262\350\256\260\345\275\225", nullptr));
        other_navigation_text->setText(QCoreApplication::translate("TeacherMainWindow", "   \345\205\266\344\273\226", nullptr));
        setting_btn->setText(QCoreApplication::translate("TeacherMainWindow", " \350\256\276\347\275\256", nullptr));
        document_btn->setText(QCoreApplication::translate("TeacherMainWindow", " \344\275\277\347\224\250\345\270\256\345\212\251", nullptr));
        version_text->setText(QCoreApplication::translate("TeacherMainWindow", "Version 1.0.0", nullptr));
        resize_icon->setText(QString());
#if QT_CONFIG(tooltip)
        minus_btn->setToolTip(QCoreApplication::translate("TeacherMainWindow", "\346\234\200\345\260\217\345\214\226", nullptr));
#endif // QT_CONFIG(tooltip)
        minus_btn->setText(QString());
#if QT_CONFIG(tooltip)
        full_or_normal_btn->setToolTip(QCoreApplication::translate("TeacherMainWindow", "\346\234\200\345\244\247\345\214\226", nullptr));
#endif // QT_CONFIG(tooltip)
        full_or_normal_btn->setText(QString());
#if QT_CONFIG(tooltip)
        close_btn->setToolTip(QCoreApplication::translate("TeacherMainWindow", "\345\205\263\351\227\255", nullptr));
#endif // QT_CONFIG(tooltip)
...
#endif // UI_TEACHER_MAIN_WINDOW_H
