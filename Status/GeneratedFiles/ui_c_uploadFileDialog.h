...
"}"));
        ...
        gridLayout->addWidget(confirm_btn, 2, 0, 1, 1);
...
"color: #999999;"));
        ...
        gridLayout_4->addWidget(filename_text, 0, 2, 1, 1);
...
"color: #666666;"));
        ...
        gridLayout_4->addWidget(file_type_pic, 0, 1, 1, 1);
...
"color: #999999;"));
        ...
        gridLayout_4->addWidget(file_size_text, 1, 1, 1, 2);

        speed_text = new QLabel(text_frame);
        speed_text->setObjectName(QString::fromUtf8("speed_text"));
        speed_text->setMinimumSize(QSize(0, 30));
        speed_text->setMaximumSize(QSize(16777215, 30));
        speed_text->setFont(font1);
        speed_text->setStyleSheet(QString::fromUtf8("background: none;\n"
"border: none;\n"
"color: #999999;"));

        gridLayout_4->addWidget(speed_text, 2, 1, 1, 2);

        time_text = new QLabel(text_frame);
        time_text->setObjectName(QString::fromUtf8("time_text"));
        time_text->setMinimumSize(QSize(0, 30));
        time_text->setMaximumSize(QSize(16777215, 30));
        time_text->setFont(font1);
        time_text->setStyleSheet(QString::fromUtf8("background: none;\n"
"border: none;\n"
"color: #999999;"));

        gridLayout_4->addWidget(time_text, 3, 1, 1, 2);


        gridLayout->addWidget(text_frame, 1, 0, 1, 1);
...
"}"));
        ...
        QObject::connect(confirm_btn, SIGNAL(clicked()), UploadFileDialog, SLOT(close()));
    ...
    void retranslateUi(QDialog *UploadFileDialog)
    {
        ...
        confirm_btn->setText(QCoreApplication::translate("UploadFileDialog", "\345\256\214\346\210\220", nullptr));
        ...
        label_5->setText(QCoreApplication::translate("UploadFileDialog", "\345\211\251\344\275\231\346\227\266\351\227\264\357\274\232", nullptr));
        label_4->setText(QCoreApplication::translate("UploadFileDialog", "\351\200\237\345\272\246\357\274\232", nullptr));
        ...
        speed_text->setText(QCoreApplication::translate("UploadFileDialog", "speed", nullptr));
        time_text->setText(QCoreApplication::translate("UploadFileDialog", "time", nullptr));
    } // retranslateUi
