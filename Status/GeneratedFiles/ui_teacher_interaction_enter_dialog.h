/********************************************************************************
** Form generated from reading UI file 'teacher_interaction_enter_dialog.ui'
**
...
#ifndef UI_TEACHER_INTERACTION_ENTER_DIALOG_H
#define UI_TEACHER_INTERACTION_ENTER_DIALOG_H
...
class Ui_TeacherInteractionEnterDialog
{
public:
    QFrame *layout;
    ...
    void setupUi(QDialog *TeacherInteractionEnterDialog)
    {
        if (TeacherInteractionEnterDialog->objectName().isEmpty())
            TeacherInteractionEnterDialog->setObjectName(QString::fromUtf8("TeacherInteractionEnterDialog"));
        TeacherInteractionEnterDialog->resize(410, 260);
        TeacherInteractionEnterDialog->setStyleSheet(QString::fromUtf8(""));
        layout = new QFrame(TeacherInteractionEnterDialog);
...
"}"));
        ...
        retranslateUi(TeacherInteractionEnterDialog);
        QObject::connect(close_btn, SIGNAL(clicked()), TeacherInteractionEnterDialog, SLOT(close()));

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(TeacherInteractionEnterDialog);
    } // setupUi

    void retranslateUi(QDialog *TeacherInteractionEnterDialog)
    {
        TeacherInteractionEnterDialog->setWindowTitle(QCoreApplication::translate("TeacherInteractionEnterDialog", "Dialog", nullptr));
#if QT_CONFIG(tooltip)
        close_btn->setToolTip(QCoreApplication::translate("TeacherInteractionEnterDialog", "\345\205\263\351\227\255", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        close_btn->setWhatsThis(QString());
#endif // QT_CONFIG(whatsthis)
        close_btn->setText(QString());
        title_text->setText(QCoreApplication::translate("TeacherInteractionEnterDialog", "\345\210\233\345\273\272\350\257\276\345\256\244", nullptr));
        confirm_btn->setText(QCoreApplication::translate("TeacherInteractionEnterDialog", "\345\210\233\345\273\272\350\257\276\345\256\244", nullptr));
        QTableWidgetItem *___qtablewidgetitem = courses_table->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("TeacherInteractionEnterDialog", "\350\257\276\347\250\213id", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = courses_table->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("TeacherInteractionEnterDialog", "\350\257\276\347\250\213\345\220\215", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(mine_courses_tab), QCoreApplication::translate("TeacherInteractionEnterDialog", "\346\210\221\347\232\204\350\257\276\347\250\213", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("TeacherInteractionEnterDialog", "\344\270\264\346\227\266\346\210\277\351\227\264", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TeacherInteractionEnterDialog: public Ui_TeacherInteractionEnterDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TEACHER_INTERACTION_ENTER_DIALOG_H
