...
void WhiteBoardWidget::createPaintConnection(QString &course_id, QString &lesson_id) {
	...
	this->setPaintConnectionSendBaseInfo(course_id, lesson_id);

	// ——信号绑定
	this->connect(this->m_board, &WhiteBoard::paintCommandReady, 
		this, &WhiteBoardWidget::sendPaintCommand);
	this->connect(this->m_paint_connection, &Connection::bufferReadyRead, 
		this, &WhiteBoardWidget::handlePaintConnectionRecv);

	return;
}

void WhiteBoardWidget::distroyPaintConnection() {
	...
	this->disconnect(this->m_board, &WhiteBoard::paintCommandReady, 
		this, &WhiteBoardWidget::sendPaintCommand);
...
void WhiteBoardWidget::setPaintConnectionSendBaseInfo(QString &course_id,
	QString &lesson_id) {
...
void WhiteBoardWidget::sendPaintCommand(QJsonObject &data) {
...
void WhiteBoardWidget::handlePaintConnectionRecv() {
...
void WhiteBoardWidget::handleCommandPaintCommand(QJsonObject &data) {
	this->m_interactive_board->paintByPaintCommand(data);
