...
InteractionWidget::InteractionWidget(QWidget *parent)
	...
	this->m_ui.chat_and_in_speech_widget_layout->addWidget(
		this->m_chat_and_in_speech_widget);

	this->connect(this->m_ui.flexible_frame_btn, &QPushButton::clicked, 
		this, &InteractionWidget::showChatAndInSpeechWidget);

	this->hideChatAndInSpeechWidget();  // Ä¬ÈÏÒþ²Ø
}
...
void InteractionWidget::showChatAndInSpeechWidget() {
	...
	this->disconnect(this->m_ui.flexible_frame_btn, &QPushButton::clicked, 
		this, &InteractionWidget::showChatAndInSpeechWidget);
	this->connect(this->m_ui.flexible_frame_btn, &QPushButton::clicked, 
		this, &InteractionWidget::hideChatAndInSpeechWidget);
