...
class TOnlineClassroomWhiteBoardController : public QObject {
	Q_OBJECT

public:
	TOnlineClassroomWhiteBoardController(TOnlineClassroomWidget *online_classroom_widget, QObject *parent = nullptr);
	virtual ~TOnlineClassroomWhiteBoardController();
