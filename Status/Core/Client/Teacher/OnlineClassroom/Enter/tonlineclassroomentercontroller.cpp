#include "tonlineclassroomentercontroller.h"


TOnlineClassroomEnterController::TOnlineClassroomEnterController(QObject *parent) 
	:QObject(parent), m_online_classroom_enter_dialog(nullptr) {

}

TOnlineClassroomEnterController::~TOnlineClassroomEnterController() {

}

void TOnlineClassroomEnterController::initOnlineClassroomEnterDialog(QWidget *parent, QList<QMap<QString, QVariant>> &data_list) {
	/*
		|-data(QMap<QString, QVariant>)
			|-course_id(QString)
			|-course_name(QString)
	*/
	Ui::TOnlineClassroomEnterDialog ui;
	QTableWidgetItem *course_id_item_temp = nullptr,
		*course_name_item_temp = nullptr;

	// ——enter dialog初始化
	this->m_online_classroom_enter_dialog = new TOnlineClassroomEnterDialog(parent);
	...
	// ——绑定信号
	this->connect(ui.confirm_btn, &QPushButton::clicked, this, &TOnlineClassroomEnterController::emitSignalCreateLesson);

	return;
}

void TOnlineClassroomEnterController::showOnlineClassroomEnterDialog(QWidget *parent, QList<QMap<QString, QVariant>> &data_list) {
...
void TOnlineClassroomEnterController::hideOnlineClassroomEnterDialog() {
...
void TOnlineClassroomEnterController::emitSignalCreateLesson() {
	Ui::TOnlineClassroomEnterDialog ui = this->m_online_classroom_enter_dialog->ui();
